...
type ClosedClientItem = {
  ...
  ageGender: string;
  chiefConcern: string[];
  closeReason: '회기 종료' | '중도 탈락' | '기타';
};

const CLOSED_CLIENTS_MOCK: ClosedClientItem[] = [
  {
    id: 'closed-1',
  ...
  {
    id: 'closed-4',
    counselingPeriod: '2025/07/04 - 2025/12/10',
    clientName: '최서윤',
    ageGender: '여성 27세',
    chiefConcern: ['불안', '완벽주의', '번아웃'],
    closeReason: '회기 종료',
  },
  {
    id: 'closed-5',
    counselingPeriod: '2025/06/18 - 2025/11/25',
    clientName: '정도현',
    ageGender: '남성 33세',
    chiefConcern: ['분노 조절', '직장 갈등', '수면'],
    closeReason: '중도 탈락',
  },
  {
    id: 'closed-6',
    counselingPeriod: '2025/05/30 - 2025/10/28',
    clientName: '한유진',
    ageGender: '여성 29세',
    chiefConcern: ['우울', '자존감', '대인관계'],
    closeReason: '회기 종료',
  },
  {
    id: 'closed-7',
    counselingPeriod: '2025/08/01 - 2026/01/03',
    clientName: '오민재',
    ageGender: '남성 26세',
    chiefConcern: ['불안', '공황', '회피'],
    closeReason: '기타',
  },
  {
    id: 'closed-8',
    counselingPeriod: '2025/09/14 - 2026/01/19',
    clientName: '윤지아',
    ageGender: '여성 35세',
    chiefConcern: ['양육 스트레스', '불면', '우울'],
    closeReason: '중도 탈락',
  },
  {
    id: 'closed-9',
    counselingPeriod: '2025/10/03 - 2026/02/11',
    clientName: '배지훈',
    ageGender: '남성 30세',
    chiefConcern: ['충동성', '대인 갈등', '분노'],
    closeReason: '회기 종료',
  },
  {
    id: 'closed-10',
    counselingPeriod: '2025/11/09 - 2026/02/06',
    clientName: '임수빈',
    ageGender: '여성 23세',
    chiefConcern: ['학업 스트레스', '불안', '수면'],
    closeReason: '기타',
  },
];
    ...
    <section className="flex w-full flex-col items-start gap-[23px]">
      ...
      <div className="w-full mb-12">
        ...
        <ul className="flex w-full flex-col">
          {CLOSED_CLIENTS_MOCK.map((item, index) => (
            <li
              key={item.id}
              className={[
                ...
                index === CLOSED_CLIENTS_MOCK.length - 1 ? 'rounded-b-[8px]' : '',
              ]
                .filter(Boolean)
                .join(' ')}
            >
              ...
              <div className="flex min-w-0 w-full items-center justify-end gap-2 pl-2">
                ...
                <Button type="button" size="md" className="w-full max-w-[181px]">
                  복구하기
                </Button>
              </div>
            </li>
