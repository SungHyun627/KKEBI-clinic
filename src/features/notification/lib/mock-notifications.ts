  ...
  return [
    {
      ...
      type: 'HIGH_PHQ9',
      title: '[위험 알림]',
      message: '김성현님의 PHQ-9 점수가 22점으로 확인되었습니다.',
      referenceId: '3',
      isRead: false,
    ...
    },
    {
      ...
      title: '[일정 변경 요청]',
      message: '김성현님이 2026년 3월 20일 14:00 일정 변경을 요청했습니다.',
      referenceId: '3',
      isRead: false,
    ...
    },
    {
      ...
      title: '[접수 분석 완료]',
      message: '김성현님의 접수면접 분석이 완료되었습니다. 결과를 확인해주세요.',
      referenceId: '3',
      isRead: true,
    ...
    },
    {
      ...
      type: 'APP_INACTIVE',
      title: '[활동 알림]',
      message: '김성현님이 7일 이상 앱에 접속하지 않았습니다.',
      referenceId: '3',
      isRead: true,
