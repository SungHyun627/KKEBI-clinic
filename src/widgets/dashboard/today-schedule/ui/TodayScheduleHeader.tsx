...
export default function TodayScheduleHeader() {
  ...
  return (
    <div className="grid w-full grid-cols-[1fr_3fr_2fr_2fr_5fr_4fr] items-center gap-3 rounded-t-2xl border border-neutral-95 bg-neutral-99 px-4 py-3">
      ...
      <TodayScheduleHeaderCell label={tDashboard('todayScheduleMoodStressScore')} align="left" />
      <span aria-hidden />
    </div>
  );
}
